...
export default class ProductA extends Component {
    ...
    try {
      ...
      if (params && params.name && email) {
        ...
        if(value !== null) {
          ...
          itemValue[params.name] = params
          delete itemValue.name
  ...
  render() {
    ...
    const ItemName = navigation.getParam('name')
      ...
      <SafeAreaView style={styles.screenContainer}>
        ...
        <ScrollView>
          <View style={styles.swiperContainer}>
            ...
            >
              <Image
                ...
                source={getImgSource(product.imageUri0)}
                style={styles.slideImg}
              />
              <Image
                defaultSource={imgHolder}
                source={getImgSource(product.imageUri1)}
                style={styles.slideImg}
              />
              <Image
                defaultSource={imgHolder}
                source={getImgSource(product.imageUri2)}
                style={styles.slideImg}
              />
            </Swiper>
          ...
          <View style={styles.descriptionContainer}>
            <View style={styles.productTitleContainer}>
              <Heading5 style={styles.productTitle}>{ItemName || product.name}</Heading5>
        ...
        <View style={styles.bottomButtonContainer}>
          ...
          <View style={styles.buttonPriceContainer}>
            <Text style={styles.buttonPriceText}>{`$ ${total.toFixed(
              2
            )}`}</Text>
          </View>
        </View>
